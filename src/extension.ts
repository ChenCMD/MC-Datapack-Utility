...
import { copyResourcePath, createDatapack, createFile, generateMultiLine, packTrailer, scoreOperation } from './commands'
...
export const activate = ({ extensionUri, subscriptions }: ExtensionContext): void => {
  ...
  disposable.push(commands.registerCommand('mcdutil.commands.packTrailer', () => packTrailer(subscriptions)))
